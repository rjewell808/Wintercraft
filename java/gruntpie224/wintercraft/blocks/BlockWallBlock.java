...
public class BlockWallBlock extends BlockBaseBlock{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (iblockstate.getBlock() == this)
        {
            ...
            switch (BlockWallBlock.SwitchEnumFacing.FACING_LOOKUP[((EnumFacing)iblockstate.getValue(FACING)).ordinal()])
            {
                case 1:
    ...
    @Override public boolean isLadder(IBlockAccess world, BlockPos pos, EntityLivingBase entity) { return false; }
