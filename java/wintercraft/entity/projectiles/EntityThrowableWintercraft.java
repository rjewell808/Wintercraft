...
public abstract class EntityThrowableWintercraft extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityThrowableWintercraft(World par1World)
    {
        super(par1World);
    ...
    public EntityThrowableWintercraft(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World);
    ...
    public EntityThrowableWintercraft(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    ...
    public void onUpdate()
    {
        ...
        if (movingobjectposition != null)
        {
            ...
            {
                this.onImpact(movingobjectposition, thrower, thrower);
            }
        }
     ...
     */
    protected abstract void onImpact(MovingObjectPosition movingobjectposition, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase);
