...
public class CustomEntityList
{
    ...
    static
    {
        ...
        addMapping(EntityGingerbread.class, "GingerBreadMan", 180, 0Xc67d2f, 0X723b00);
        addMapping(EntityPolarBear.class, "Polarbear", 181, 0XB4B4B5,0XCFD3D5);
        addMapping(EntityPenguin.class, "Penguin", 182, 0X1b1d43,0Xcbced8);
        addMapping(EntityMiniSnowGolem.class, "MiniSnowGolem", 183, 0Xeaf1f1,0X82e2e5);
        addMapping(EntitySnowMan.class, "SnowMan", 184, 0XC0C0C0,0X585858);
        addMapping(EntityReindeer.class, "Reindeer", 185, 0X835A18,0XC8994E);
        addMapping(EntityAlbinoReindeer.class,"AlbinoReindeer",186,0XFF2B32,0XEEE5FF);
        addMapping(EntityElf.class,"Elf",187,0X49B74B,0XFF7070);
    }
}