...
public class EntitySnowMan extends EntityGolem implements IRangedAttackMob{
    ...
    public void onLivingUpdate()
    {
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            if (this.worldObj.getBlock(i, j, k) == Blocks.air && this.worldObj.getBiomeGenForCoords(i, k).getFloatTemperature(i, j, k) < 0.8F && Blocks.snow_layer.canPlaceBlockAt(this.worldObj, i, j, k))
            {
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            this.dropItem(WinterItems.rockySnowball, 1);
        }
    }
    ...
    {
        EntityRockySnowball entitysnowball = new EntityRockySnowball(this.worldObj, this);
