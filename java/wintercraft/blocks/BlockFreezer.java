...
public class BlockFreezer extends BlockContainer
{
    ...
    protected BlockFreezer(boolean par2)
    {
        super(Material.rock);
        this.isActive = par2;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			TileEntityFreezer var10 = (TileEntityFreezer) par1World.getTileEntity(par2, par3, par4);
		if (var10 != null)
		{
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, WinterBlocks.freezerActive);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, WinterBlocks.freezer);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        ...
        {
            TileEntityFreezer tileentityfurnace = (TileEntityFreezer)par1World.getTileEntity(par2, par3, par4);
