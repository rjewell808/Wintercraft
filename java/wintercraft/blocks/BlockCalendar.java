...
public class BlockCalendar extends BlockBaseBlock{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		if(!par5EntityPlayer.worldObj.isRemote){
			...
			if(month == 11 && day == 25){
				...
				if(dayCount > 1){
					par5EntityPlayer.addChatMessage(new ChatComponentText("Only: \u00a7c\u00a7l" + dayCount + "\u00a7r days 'til Christmas!"));
				}else{
					par5EntityPlayer.addChatMessage(new ChatComponentText("Only: \u00a7a\u00a7l" + dayCount + "\u00a7r day 'til Christmas!"));
				}
			}
