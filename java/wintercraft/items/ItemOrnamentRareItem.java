...
public class ItemOrnamentRareItem extends ItemBaseItem{
	...
	public ItemOrnamentRareItem(Block ornament) {
		super();
	...
	public void registerIcons(IIconRegister par1IconRegister)
	{
	       ...
	       {
	    	   icons[i] = par1IconRegister.registerIcon(Wintercraft.modid + ":" +"ornamentItem/rare/" + (this.getUnlocalizedName().substring(5)) + i);
	       }
	}
	 ...
	 public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
	    {
	        ...
	        if (block == WinterSpecialBlocks.ornament || block == Blocks.snow_layer && (p_77648_3_.getBlockMetadata(p_77648_4_, p_77648_5_, p_77648_6_) & 7) < 1)
	        {
	            p_77648_7_ = 1;
	        }
